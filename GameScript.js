...
function End(){
  ...
  document.getElementById("aaa").style.marginTop="20%"  ;   //show x score in center of page
  // document.getElementById("playerTwo").style.marginTop="200px"  ;      //show x score in center of page
}
